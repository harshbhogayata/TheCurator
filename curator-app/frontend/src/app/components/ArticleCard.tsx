    ...
    return (
      <article className="group relative flex min-w-0 gap-4">
        <div
          ...
          style={{ borderRadius: '40px 20px 50px 30px' }}
        >
          <ImageWithFallback
  ...
  if (variant === 'featured') {
    return (
      <article className="relative cursor-pointer">
        <div
          onClick={handleArticleClick}
          className="group relative mb-4 h-[300px] w-full overflow-hidden border border-outline-variant/15 shadow-xl"
          style={{ borderRadius: '80px 40px 100px 60px' }}
        >
          <ImageWithFallback
          ...
          <div className="absolute bottom-6 left-6 right-6">
            ...
            <h3 className="text-2xl leading-tight text-on-surface">{article.title}</h3>
          </div>
        </div>
