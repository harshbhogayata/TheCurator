...
from users.mobile_auth_pages import (
    MobileResetPasswordConfirmView,
    MobileResetPasswordPageView,
    MobileVerifyEmailConfirmView,
...
urlpatterns = [
    ...
    path("m/reset-password/confirm", MobileResetPasswordConfirmView.as_view(), name="mobile-reset-password-confirm"),
    path("m/verify-email", MobileVerifyEmailPageView.as_view(), name="mobile-verify-email"),
    path("m/verify-email/confirm", MobileVerifyEmailConfirmView.as_view(), name="mobile-verify-email-confirm"),
