...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "billing.authentication.FirebaseOrCheckoutHandoffAuthentication",
    ],
...
GUARDIAN_API_KEY = env("GUARDIAN_API_KEY", default="")
GUARDIAN_API_DAILY_REQUEST_BUDGET = env.int("GUARDIAN_API_DAILY_REQUEST_BUDGET", default=5000)
GNEWS_API_KEY = env("GNEWS_API_KEY", default="")
GNEWS_DAILY_REQUEST_BUDGET = env.int("GNEWS_DAILY_REQUEST_BUDGET", default=100)
APITUBE_API_KEY = env("APITUBE_API_KEY", default="")
APITUBE_DAILY_REQUEST_BUDGET = env.int("APITUBE_DAILY_REQUEST_BUDGET", default=200)
MEDIASTACK_API_KEY = env("MEDIASTACK_API_KEY", default="")
MEDIASTACK_MONTHLY_REQUEST_BUDGET = env.int("MEDIASTACK_MONTHLY_REQUEST_BUDGET", default=500)
WORLDNEWS_API_KEY = env("WORLDNEWS_API_KEY", default="")
WORLDNEWS_DAILY_REQUEST_BUDGET = env.int("WORLDNEWS_DAILY_REQUEST_BUDGET", default=50)
...
PIPELINE_RESOLVE_IMAGES_ON_RUN = env.bool("PIPELINE_RESOLVE_IMAGES_ON_RUN", default=True)
PIPELINE_IMAGE_LIMIT = env.int("PIPELINE_IMAGE_LIMIT", default=25)
# Daily audio brief from the last day's published articles (one per local calendar day).
PIPELINE_DAILY_BRIEF_ENABLED = env.bool("PIPELINE_DAILY_BRIEF_ENABLED", default=True)
PIPELINE_DAILY_BRIEF_AUTO_PUBLISH = env.bool("PIPELINE_DAILY_BRIEF_AUTO_PUBLISH", default=True)
PIPELINE_DAILY_BRIEF_MIN_ARTICLES = env.int("PIPELINE_DAILY_BRIEF_MIN_ARTICLES", default=3)
