...
class MobileApiContractTests(TestCase):
    ...
    def test_entitlement_payload_exposes_both_camel_and_snake_case_override_fields(self):
        ...
        self.assertTrue(response.data["qa_override_enabled"])
        self.assertTrue(response.data["qaOverrideEnabled"])
        self.assertEqual(response.data["qa_override_tier"], "premium")
    ...
    def test_namespaced_api_routes_resolve_to_stable_paths(self):
        ...
        self.assertEqual(reverse("api:users:auth-session"), "/api/mobile/auth/session")
        self.assertEqual(reverse("api:users:account"), "/api/mobile/account")
        self.assertEqual(reverse("api:onboarding:state"), "/api/mobile/onboarding/")
